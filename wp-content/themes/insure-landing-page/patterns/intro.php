...
<figure class="wp-block-image insure-intro__image insure-intro__image--mobile"><img src="<?php echo esc_url( $assets . 'image-intro-mobile.jpg' ); ?>" alt="Family of four holding hands while walking together on a wet sidewalk against a white brick wall"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image insure-intro__image insure-intro__image--desktop"><img src="<?php echo esc_url( $assets . 'image-intro-desktop.jpg' ); ?>" alt="Family of four holding hands while walking together on a wet sidewalk against a white brick wall"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
